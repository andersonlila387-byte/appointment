...
<body class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-zinc-900 overflow-hidden border-r border-white/5">
        ...
        <div class="relative z-10 flex flex-col justify-between p-16 w-full">
            ...
            <!-- Content -->
            <div class="space-y-8">
                <h2 class="text-5xl font-bold text-white leading-[1.1]">Welcome back to <br/> <span class="text-blue-500">your command center.</span></h2>
                <p class="text-zinc-400 text-lg max-w-md leading-relaxed">Manage your appointments, team, and payments from one unified dashboard.</p>
                
                <div class="flex items-center gap-4 pt-4">
                    <div class="flex -space-x-3">
                        <div class="w-12 h-12 rounded-full bg-zinc-800 border-4 border-zinc-900 overflow-hidden"><img src="https://i.pravatar.cc/100?img=33" alt="" class="w-full h-full object-cover opacity-80"></div>
                        <div class="w-12 h-12 rounded-full bg-zinc-800 border-4 border-zinc-900 overflow-hidden"><img src="https://i.pravatar.cc/100?img=47" alt="" class="w-full h-full object-cover opacity-80"></div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <span class="text-sm text-zinc-500 font-medium">Trusted by 10,000+ businesses</span>
                    </div>
                </div>
            </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 relative bg-black">
        ...
        <div class="w-full max-w-md space-y-10 mt-12 lg:mt-0">
            <div class="text-left">
                <h1 class="text-3xl md:text-4xl font-bold text-white tracking-tight">Sign in</h1>
                <p class="text-zinc-400 mt-3 text-lg">Access your dashboard.</p>
            </div>
            ...
            <form id="loginForm" class="space-y-5">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        <label class="block text-sm font-semibold text-zinc-300">Password</label>
                        <a href="forgot-password.php" class="text-sm text-blue-500 hover:text-blue-400 transition-colors">Forgot password?</a>
                    </div>
                    <div class="relative">
            ...
            <div class="text-center text-sm text-zinc-500">
                Don't have an account? <a href="register.php" class="text-white hover:text-blue-400 font-semibold transition-colors">Create one</a>
            </div>
        </div>
    </div>
